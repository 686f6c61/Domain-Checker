/**
 * @fileoverview Script principal para la extensión de Chrome Domain Checker.
 * Este script maneja la funcionalidad de búsqueda de dominios, verificación de disponibilidad
